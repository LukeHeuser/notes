...
```
The wrapper class in this case is the keyword ***Integer***, shown as an expression. To isntatiate a wrapper class, the full name of the primitive data type starting with a capital letter followed by the function you wish to use.
